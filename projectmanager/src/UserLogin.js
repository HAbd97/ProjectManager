                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" value={this.state.username} onChange={this.getUsername}/>
                        </div>
                      </div>
                      <br/><br/>
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <input type="password" className="form-control" value={this.state.password} onChange={this.getPassword}/>
                        </div>
                      </div>
                    </div>
